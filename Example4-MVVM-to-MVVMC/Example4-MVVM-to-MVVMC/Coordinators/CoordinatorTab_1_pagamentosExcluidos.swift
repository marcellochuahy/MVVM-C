...
class CoordinatorTab_1_pagamentosExcluidos: Coordinator {
...
extension CoordinatorTab_1_pagamentosExcluidos: ListaDePagamentosDelegate {
...
extension CoordinatorTab_1_pagamentosExcluidos: ComprovanteDePagamentoDelegate {
  func dismiss() {
    //
  }
}
